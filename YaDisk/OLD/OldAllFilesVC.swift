...
//import CoreData
//
//class OldAllFilesVC: UITableViewController {
//    
...
//                 }
//                 cell.name.text = fileItem.name
//                 cell.size.text = formatFileSize(fileItem.size)
//                 return cell
//             }
...
//            }
//            
//            resources?.items.forEach { resource in
...
//    }
//
//    func updateUI(with files: [FilesItem]) {
//        self.response?.items = files
//        DispatchQueue.main.async {
//            self.tableView.reloadData()
//        }
//    }
